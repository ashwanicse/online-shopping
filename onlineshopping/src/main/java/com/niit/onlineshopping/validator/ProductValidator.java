...
public class ProductValidator implements Validator{
	...
	public boolean supports(Class<?> clazz) {
		...
		return Product.class.equals(clazz); //will check Product is here or not
	}
	...
	public void validate(Object target, Errors errors) {
		...
		//check  uploading image or something else
		if(! (
			...
			errors.rejectValue("file", null, "Please use only image to upload");
			return;
		}
